InvasiveAquaticPlantsChile_Download_and_Depurate <- function(){
  ###########################################################
  ################## DESCARGAR ##############################
  ###########################################################
  url <- "https://gayanabotanica.cl/index.php/gb/article/download/245/81/1891"
  destfile <- "InputFiles/Step0_OriginalDatabase_InvasiveAquaticPlantsChile.pdf"
  ...
  tabla_df <- tabla_df[-1,]
  write.xlsx(tabla_df, "Inputfiles/Step0_OriginalDatabase_InvasiveAquaticPlantsChile.xlsx")
  ...
  write.xlsx(freshwater_species, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_InvasiveAquaticPlantsChile.xlsx")
}
