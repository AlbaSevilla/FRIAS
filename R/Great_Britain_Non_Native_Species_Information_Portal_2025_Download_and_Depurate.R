Great_Britain_Non_Native_Species_Information_Portal_2025_Download_and_Depurate <- function(){
  ...
  #Guardamos el html
  writeLines(html_texto, "Inputfiles/html_Great_Britain_Non_Native_Species_Information_Portal_2025_Download_and_Depurate.html")
  ...
  #Guardamos
  write.xlsx(resultados, "Inputfiles/Step0_OriginalDatabase_Great_Britain_Non_Native_Species_Information_Portal_2025.xlsx")
  ...
  #Guardamos
  write.xlsx(dat_fresh, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Great_Britain_Non_Native_Species_Information_Portal_2025.xlsx")
