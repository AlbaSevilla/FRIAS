Obtain_FunctionalGroup <- function(){
  ...
  #write.xlsx(MasterList, "OutputFiles/Intermediate/Step8_ObtainFuctionalGroup_Masterlist.xlsx")
  ...
  write.xlsx(MasterList, "Outputfiles/Intermediate/Step7.1_ObtainFunctionalGroup_Masterlist.xlsx")
  ...
  MasterList2 <- read_excel("Outputfiles/Intermediate/Step7.1_ObtainFunctionalGroup_Masterlist.xlsx")
  ...
  # Guardar resultado
  write.xlsx(mergedatasets, "OutputFiles/Intermediate/Step7_ObtainFuctionalGroup_Masterlist.xlsx")
}
