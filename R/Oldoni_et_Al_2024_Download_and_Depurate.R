Oldoni_et_Al_2024_Download_and_Depurate <- function(){
  ...
  write.xlsx(DATASET_sinduplicados, "./InputFiles/Step0_OriginalDatabase_Oldoni_et_Al_2024.xlsx")
  cat("Archivo descargado correctamente: Step0_OriginalDatabase_Oldoni_et_Al_2024.xlsx", "\n")
  ...
  write.xlsx(dataset_freshwater, "./InputFiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Oldoni_et_Al_2024.xlsx")
  cat("Archivo descargado correctamente: Step0_OriginalDatabaseFreshwaterNODUPLICATES_Oldoni_et_Al_2024.xlsx", "\n")
