NonNativeSpeciesInReservoirsBrazil_Download_and_Depurate <- function(){
  ###########################################################
  ################## DESCARGAR ##############################
  ###########################################################
  url <- "https://static-content.springer.com/esm/art%3A10.1007%2Fs10750-017-3446-2/MediaObjects/10750_2017_3446_MOESM2_ESM.xlsx"
  destfile <- "InputFiles/Step0_OriginalDatabase_NonNativeSpeciesInReservoirsBrazil.xlsx"
  download.file(url, destfile, mode = "wb")

  ##########################################################
  ############### obtener información de interés ###########
  ##########################################################
  dat <- read_excel("Inputfiles/Step0_OriginalDatabase_NonNativeSpeciesInReservoirsBrazil.xlsx", sheet="Introduced Species")
  head(dat)
  ...
  write.xlsx(freshwater_species, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_NonNativeSpeciesInReservoirsBrazil.xlsx")
}
