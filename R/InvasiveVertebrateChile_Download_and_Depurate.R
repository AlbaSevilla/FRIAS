InvasiveVertebrateChile_Download_and_Depurate <- function(){
  ###########################################################
  ################## DESCARGAR ##############################
  ###########################################################
  url <- "https://www.scielo.cl/pdf/rchnat/v78n1/art10.pdf"
  destfile <- "InputFiles/Step0_OriginalDatabase_InvasiveVertebrateChile_Download_and_Depurate.pdf"
  ...
  write.csv2(dataset_corregido, "./Inputfiles/Step0_OriginalDatabase_InvasiveVertebrateChile.csv")

  #####################################################################################
  ################## FUNCTION TO OBTAIN SPECIES HABITAT ###############################
  #####################################################################################
  Database <- read.csv("Inputfiles/Step0_OriginalDatabase_InvasiveVertebrateChile.csv", sep=";")
  ...
  write.xlsx(Database, "./Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_InvasiveVertebrateChile.xlsx")
  cat("Archivo descargado correctamente: /Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_InvasiveVertebrateChile.xlsx")
