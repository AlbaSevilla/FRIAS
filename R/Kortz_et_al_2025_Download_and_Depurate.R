Kortz_et_al_2025_Download_and_Depurate <- function(){
  ...
  destfile <- "InputFiles/Step0_OriginalDatabase_Kortz_et_al_2025.docx"
  ...
  dat <- read_docx("Inputfiles/Step0_OriginalDatabase_Kortz_et_al_2025.docx")
  ...
  write.xlsx(dat_fresh2, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Kortz_et_al_2025.xlsx")
  cat("Archivo descargado correctamente: Step0_OriginalDatabaseFreshwaterNODUPLICATES_Kortz_et_al_2025.xlsx", "\n")
  # write.csv2(Kortz_et_al_2025_sinduplicados, "./Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Kortz_et_al_2025.csv")
  # cat("Archivo descargado correctamente: Step0_OriginalDatabaseFreshwaterNODUPLICATES_Kortz_et_al_2025.csv", "\n")
  #
}
