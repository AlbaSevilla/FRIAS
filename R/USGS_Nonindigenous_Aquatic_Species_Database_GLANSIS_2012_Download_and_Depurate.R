USGS_Nonindigenous_Aquatic_Species_Database_GLANSIS_2012_Download_and_Depurate <- function(){
  ...
  res2 <- res %>% html_table
  res3 <- res2[[2]]
  write.xlsx(res3, "Inputfiles/Step0_OriginalDatabase_USGS_Nonindigenous_Aquatic_Species_Database_GLANSIS_2012.xlsx")

  #########################################################
  ################# DEPURAR ###############################
  #########################################################
  ruta_inputfiles <- file.path("Inputfiles")
  data_name <- list.files(path = ruta_inputfiles, pattern = "Step0_OriginalDatabase_USGS_Nonindigenous_Aquatic_Species_Database_GLANSIS_2012.xlsx", full.names = TRUE)
  ...
  write.xlsx(dat_fresh, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_USGS_Nonindigenous_Aquatic_Species_Database_GLANSIS_2012.xlsx")
}
