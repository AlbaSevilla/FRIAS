Bailey_et_Al_2021_Download_and_Depurate <- function(){
  ...
  #DEPURAR
  dat <- read_excel("InputFiles/Step0_OriginalDatabaseBailey_et_Al_2021.xlsx", sheet=2)
  head(dat)
  dat <- dat %>%
  ...
  #Save the dataset
  write.xlsx(dat_2, "InputFiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Bailey_et_Al_2021.xlsx")
  cat("Step0_OriginalDatabaseFreshwaterNODUPLICATES_Bailey_et_Al_2021.xlsx saved")
}
