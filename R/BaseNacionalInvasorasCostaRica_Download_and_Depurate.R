BaseNacionalInvasorasCostaRica_Download_and_Depurate <- function() {
  ...
  data_name_CostaRica <- list.files(path = ruta_InputFiles, pattern = "Step0_OriginalDatabase_BaseNacionalInvasorasCostaRica.xlsx", full.names = TRUE)
  ...
  write.xlsx (dataset_freshwater, "./InputFiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_BaseNacionalInvasorasCostaRica.xlsx")
  cat("El archivo se descargó correctamente: InputFiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_BaseNacionalInvasorasCostaRica.xlsx")
