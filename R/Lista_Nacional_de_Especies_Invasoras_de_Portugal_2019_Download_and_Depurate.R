Lista_Nacional_de_Especies_Invasoras_de_Portugal_2019_Download_and_Depurate <- function(){
  ...
  destfile <- "InputFiles/Step0_OriginalDatabase_Lista_Nacional_de_Especies_Invasoras_de_Portugal_2019.pdf"
  ...
  write.xlsx(DATASET_Portugal, "./Inputfiles/Step0_OriginalDatabase_Lista_Nacional_de_Especies_Invasoras_de_Portugal_2019.xlsx")
  ...
  write.xlsx(dataset_freshwater, "./Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Lista_Nacional_de_Especies_Invasoras_de_Portugal_2019.xlsx")
  cat("Archivo descargado correctamente: /Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Lista_Nacional_de_Especies_Invasoras_de_Portugal_2019.xlsx")
