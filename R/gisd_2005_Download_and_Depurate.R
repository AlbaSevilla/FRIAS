...
gisd_2005_Download_and_Depurate <- function() {
  ...
  ############ DEPURAR ##############################
  datos <- read.csv("Inputfiles/Step0_OriginalDatabase_gisd_2005.csv", sep=";")
  head(datos)
  names(datos)
  ...
  gisd_2005_sinduplicados <- noduplicates(gisd_2005_FRESHWATER, column_name_species = "Species")

  write.xlsx(gisd_2005_sinduplicados, "./Inputfiles/freshwatersubset_gisd_2005.xlsx")
}
