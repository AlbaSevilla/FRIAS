petrosyan_et_al_2023_Download_and_Depurate <- function() {
  ...
  dat <- read.xlsx("InputFiles/originaldatabase_petrosyan_et_al_2023.xlsx")#Aquí estamos indicando que sustraiga los excel de las bases de dat iniciales de la carpeta 'InputFiles'.
  dat <- dat[,-1]
