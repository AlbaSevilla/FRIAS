Dahruddin_et_Al_2017_Download_and_Depurate <- function(){
  ...
  ##########################################################
  dat <- read_excel("Inputfiles/Step0_OriginalDatabase_Dahruddin_et_Al_2017.xlsx")
  dat
  ...
  write.xlsx(freshwater_species, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Dahruddin_et_Al_2017.xlsx")
}
