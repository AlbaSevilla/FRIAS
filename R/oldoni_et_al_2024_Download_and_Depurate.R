oldoni_et_al_2024_Download_and_Depurate <- function(){
  ...
  write.xlsx(DATASET_sinduplicados, "./InputFiles/originaldatabase_oldoni_et_al_2024.xlsx")
  cat("Archivo descargado correctamente: originaldatabase_oldoni_et_al_2024.xlsx", "\n")
