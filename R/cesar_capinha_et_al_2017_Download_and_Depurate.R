cesar_capinha_et_al_2017_Download_and_Depurate <- function() {
  ...
  dat <- read.xlsx("InputFiles/originaldatabase_cesar_capinha_et_al_2012_v2", sheet=2) # Aquí estamos indicando que sustraiga los excel de las bases de datos iniciales de la carpeta 'InputFiles'.
