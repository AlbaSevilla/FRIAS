iucnredlist_fillgapsNativeRange <- function(){
  ...
  MasterList <- read_excel("OutputFiles/Intermediate/step7_obtainfunctionalgroup_masterlist.xlsx")
  ...
  #Save
  write.csv(results_masterlist,"InputFiles/NativeCountrysMasterlistByIUCN.csv")

  #Final Result:
  results_masterlist <- read_csv("InputFiles/NativeCountrysMasterlistByIUCN.csv")
  ...
  merged_results <- MasterList %>%
    ...
    mutate(NativeCountry = paste(NativeCountry, country_occurrence, sep = "; ")) %>%
    mutate(NativeCountry = str_replace_all(NativeCountry, c(
      "NA; " = "",
      "NA; Native, : " = "",
      "Native, : " = "",
  ...
  write_xlsx(merged_results,"OutputFiles/Intermediate/step8_additionaldatalocations_masterList.xlsx")
  write_csv(merged_results,"OutputFiles/Intermediate/step8_additionaldatalocations_masterList.csv")
}
