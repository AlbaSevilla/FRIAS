great_britain_non_native_species_information_portal_2025_Download_and_Depurate <- function(){
  ...
  #Guardamos el html
  writeLines(html_texto, "Inputfiles/html_great_britain_non_native_species_information_portal_2025.html")
  ...
  #Guardamos
  write.xlsx(resultados, "Inputfiles/originaldatabase_great_britain_non_native_species_information_portal_2025.xlsx")
  ...
  #Guardamos
  write.xlsx(dat_fresh, "Inputfiles/freshwatersubset_great_britain_non_native_species_information_portal_2025.xlsx")
}
