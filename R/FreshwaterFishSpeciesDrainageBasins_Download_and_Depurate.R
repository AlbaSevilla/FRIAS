FreshwaterFishSpeciesDrainageBasins_Download_and_Depurate <- function(){
  ##############################################
  ############## DESCARGAR #####################
  ##############################################
  url <- "https://figshare.com/ndownloader/files/8964583"
  destfile <- "InputFiles/OriginalDatabase_FreshwaterFishSpeciesDrainageBasins.zip"
  ...
  unzip("InputFiles/OriginalDatabase_FreshwaterFishSpeciesDrainageBasins.zip", exdir = "InputFiles")
  ...
  rownames(dat) <- NULL
  head(dat)
  write.csv2(dat, "Inputfiles/Step0_OriginalDatabase_FreshwaterFishSpeciesDrainageBasins.csv")
  ...
  write.xlsx(DatabaseBasin, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_FreshwaterFishSpeciesDrainageBasins.xlsx")
}
