Gilles_et_al_2025_Download_and_Depurate <- function(){
  ###########################################################
  ################## DESCARGAR ##############################
  ###########################################################
  #A mano de
  ...
  ##########################################################
  destfile <- "Inputfiles/Step0_OriginalDatabase_Gilles_et_al_2025.pdf"
  ...
  write_xlsx(Tabla_final, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Gilles_et_al_2025.xlsx")
}
