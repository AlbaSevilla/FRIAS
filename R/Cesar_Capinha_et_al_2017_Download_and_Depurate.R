Cesar_Capinha_et_al_2017_Download_and_Depurate <- function() {
  ...
  data_name_reptiles0 <- list.files(path = ruta_InputFiles, pattern = "Step0_OriginalDatabasewithHabitat_Cesar_Capinha_et_al_2017_Cesar.xlsx", full.names=TRUE)
  ...
  data_name_reptiles <- list.files(path = ruta_InputFiles, pattern = "Step0_OriginalDatabase_Cesar_Capinha_et_al_2017.xlsx", full.names=TRUE)
  ...
  write.xlsx(dataset_freshwater, "./InputFiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Cesar_Capinha_et_al_2017.xlsx")
  cat("Archivo descargado correctamente: /InputFiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Cesar_Capinha_et_al_2017.xlsx")
}
