iriarte_et_al_2005_Download_and_Depurate <- function(){
  ...
  write.csv2(dataset_corregido, "./Inputfiles/originaldatabase_iriarte_et_al_2005.csv")

  #####################################################################################
  ################## FUNCTION TO OBTAIN SPECIES HABITAT ###############################
  #####################################################################################
  Database <- read.csv("Inputfiles/originaldatabase_iriarte_et_al_2005.csv", sep=";")
  ...
  write.xlsx(Database, "./Inputfiles/freshwatersubset_iriarte_et_al_2005.xlsx")
}
