AlienAnimalsSouthAfrica_Download_and_Depurate <- function(){
  ###########################################################
  ################## DESCARGAR ##############################
  ###########################################################
  #A mano
  ...
  ##########################################################
  archivo <- "InputFiles/Step0_OriginalPDF_AlienAnimalsSouthAfrica.pdf"
  ...
  write.xlsx(tabla_df, "InputFiles/Step0_OriginalDatabase_AlienAnimalsSouthAfrica.xlsx", rowNames = FALSE)
  ...
  write.xlsx(tabla_final3, "InputFiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_AlienAnimalsSouthAfrica.xlsx")
}
