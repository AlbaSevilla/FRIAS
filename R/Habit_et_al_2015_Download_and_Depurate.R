Habit_et_al_2015_Download_and_Depurate <- function(){
  ...
  destfile <- "InputFiles/Step0_OriginalDatabase_Habit_et_al_2015.pdf"
  ...
  write.xlsx(df, "Inputfiles/Step0_OriginalDatabase_Habit_et_al_2015.xlsx")
  ...
  write.xlsx(freshwater_species, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Habit_et_al_2015.xlsx")
}
