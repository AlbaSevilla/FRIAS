Takhteev_et_Al_2015_Download_and_Depurate <- function(){
  ...
  destfile <- "InputFiles/Step0_OriginalDatabase_Takhteev_et_Al_2015.pdf"
  ...
  Dataset <- read_excel("Inputfiles/Step0_OriginalDatabase_Takhteev_et_Al_2015.xlsx")
  ...
  write.xlsx(dataset_freshwater, "./Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Takhteev_et_Al_2015.xlsx")
  cat("Archivo descargado correctamente: /Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Takhteev_et_Al_2015.xlsx")
