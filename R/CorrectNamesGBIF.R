CorrectNamesGBIF <- function(){
  ...
  MasterList <- read.xlsx("OutputFiles/Intermediate/Step10_NoMicroorganism_MasterList.xlsx")
  ...
  dim(MasterList_filtrada)

  write.xlsx(MasterList_filtrada,
             file.path("OutputFiles", "Intermediate", paste0("Step3_CorrectedAcceptedNameGBIF_Masterlist.xlsx")),
             sep = ";",
             row.names = FALSE,
             col.names = TRUE)
