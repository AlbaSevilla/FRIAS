nies_invasive_species_of_japan_2002_Download_and_Depurate <- function(){
  ...
  dataset_results$Scientific_name <- dataset_results$dataset_results
  ...
  names <- dataset_noduplicates$Scientific_name
  dataset_noduplicates$AcceptedNameGBIF <- name_backbone_checklist(names)$canonicalName
