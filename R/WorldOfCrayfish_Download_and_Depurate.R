WorldOfCrayfish_Download_and_Depurate <- function() {
  ...
  ################################################################
  dat <- read.xlsx(file.path("Inputfiles","Step0_OriginalDatabase_WorldOfCrayfish.xlsx"))
  names(dat)
  dat <- dat[,-20]
  ...
  write.xlsx(dat4, "./Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_WorldOfCrayfish.xlsx")
  cat("Archivo descargado correctamente: /Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_WorldOfCrayfish.xlsx")
