Obtain_FunctionalGroup <- function(){
  ...
  #Save
  write.xlsx(allmasterlist_final,"OutputFiles/Intermediate/step14_obtainfunctionalgroup_masterlist.xlsx")
  write.csv(allmasterlist_final,"OutputFiles/Intermediate/step14_obtainfunctionalgroup_masterlist.csv")
}
