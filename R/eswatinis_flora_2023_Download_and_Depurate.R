eswatinis_flora_2023_Download_and_Depurate <- function(){
  ...
  #Guardamos
  write.xlsx(resultados, "Inputfiles/originaldatabase_eswatinis_flora_2023.xlsx")
  ...
  #Guardamos
  write.xlsx(dataset, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_eswatinis_flora_2023.xlsx")
