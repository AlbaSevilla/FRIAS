Jellyfish_Download_and_Depurate <- function() {
  ################################################################################
...
#   destfile <- "InputFiles/Step0_OriginalDatabase_Jellyfish.xlsx" #Directorio donde se guardará y con qué nombre
...
#   cat("Archivo descargado correctamente:", destfile, "\n")
  ...
  datos <- read.xlsx(file.path("Inputfiles","Step0_OriginalDatabase_Jellyfish.xlsx"),sep=";")
  ...
  write.xlsx(datos,file.path("Inputfiles", paste( "Step0_OriginalDatabaseFreshwaterNODUPLICATES_Jellyfish.xlsx")), rowNames = FALSE)
  destfile <- "InputFiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Jellyfish.xlsx" #Directorio donde se guardará y con qué nombre
  cat("Archivo descargado correctamente:", destfile, "\n")
}
