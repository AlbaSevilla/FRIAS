List_for_Invasive_Alien_Species_Management_in_Japan_2015_Download_and_Depurate <- function(){
  ...
  destfile <- "InputFiles/Step0_OriginalDatabase_List_for_Invasive_Alien_Species_Management_in_Japan_2015.pdf"
  ...
  write.xlsx(DATASET_JAPON, "./Inputfiles/Step0_OriginalDatabase_List_for_Invasive_Alien_Species_Management_in_Japan_2015.xlsx")
  ...
  write.xlsx(dataset_freshwater, "./Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_List_for_Invasive_Alien_Species_Management_in_Japan_2015.xlsx")
  cat("Archivo descargado correctamente: /Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_List_for_Invasive_Alien_Species_Management_in_Japan_2015.xlsx")
