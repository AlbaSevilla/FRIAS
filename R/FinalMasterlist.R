FinalMasterlist <- function(){
  MasterList <- read.xlsx("OutputFiles/Intermediate/step14_obtainfunctionalgroup_masterlist.xlsx") %>%
  ...
  Standardization_Impact <- read_excel("TablesToStandardize/Table S2.xlsx", sheet = "8.1 Impact", col_names = TRUE)
