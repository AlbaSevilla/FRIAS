EASIN_2025_Download_and_Depurate <- function(){
  ...
  write.xlsx(dataset_FINAL,
             file.path("Inputfiles", paste0("Step0_OriginalDatabaseFreshwaterNODUPLICATES_EASIN_2025.xlsx")),
             sep = ",",
             rowNames = FALSE,
             colNames = TRUE)
  cat("Archivo guardado correctamente : Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_EASIN_2025.xlsx")
}
