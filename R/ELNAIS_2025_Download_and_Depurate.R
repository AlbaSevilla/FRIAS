ELNAIS_2025_Download_and_Depurate <- function(){
  ...
  write.xlsx(res6, "Inputfiles/Step0_OriginalDatabase_ELNAIS_2025.xlsx")
  ...
  write.xlsx(dat_fresh, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_ELNAIS_2025.xlsx")
