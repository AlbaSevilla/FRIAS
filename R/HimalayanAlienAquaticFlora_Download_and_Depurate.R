HimalayanAlienAquaticFlora_Download_and_Depurate <- function(){
  ###########################################################
  ################## DESCARGAR ##############################
  ###########################################################
  ...
  # destfile <- "InputFiles/Step0_OriginalDatabase_HimalayanAlienAquaticFlora.pdf"
  ...
  # write.xlsx(dataset, "Inputfiles/Step0_OriginalDatabase_HimalayanAlienAquaticFlora.xlsx")


  dataset <- read_excel("Inputfiles/Step0_OriginalDatabase_HimalayanAlienAquaticFlora.xlsx")
  #Habitat
  ...
  write.xlsx(freshwater_species, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_HimalayanAlienAquaticFlora.xlsx")
}
