FreshwaterFishesSingapore_Download_and_Depurate <- function(){
  ###########################################################
  ################## DESCARGAR ##############################
  ###########################################################
  #A mano
  ...
  ##########################################################
  archivo <- "Inputfiles/Step0_OriginalPDF_FreshwaterFishesSingapore.pdf"
  ...
  # 11. Exporta a Excel
  write.xlsx(tabla_df2, "Inputfiles/Step0_OriginalDatabase_FreshwaterFishesSingapore.xlsx", rowNames = FALSE)
  ...
  write.xlsx(tabla_df3, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_FreshwaterFishesSingapore.xlsx")
}
