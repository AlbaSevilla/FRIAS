Obtain_TaxonNAS <- function() {
  dataset <- read.xlsx("OutputFiles/Intermediate/Step4_SelectedFreshwaterGBIF_Masterlist.xlsx")
  ...
  source(file.path("R", "consulta_taxonomia.r"))
  ...
  write.xlsx(dataset3,
             file.path("OutputFiles", "Intermediate", "Step5.1_ObtainTaxonNAS_MasterList.xlsx"),
             row.names = FALSE,
             col.names = TRUE,
             quote = FALSE)
  ...
  dataset4 <- read_excel("Outputfiles/Intermediate/Step5.1_ObtainTaxonNAS_MasterList.xlsx")
  ...
  dataset5 <- noduplicates(dataset4,"OriginalNameDB")
