cesar_capinha_et_al_2017_Download_and_Depurate <- function() {
  ...
  data_name_reptiles0 <- list.files(path = ruta_InputFiles, pattern = "originaldatabase_cesar_capinha_et_al_2017.xlsx", full.names=TRUE)
  ...
  data_name_reptiles <- list.files(path = ruta_InputFiles, pattern = "originaldatabase_cesar_capinha_et_al_2012_v2", full.names=TRUE)
  ...
  cat("Archivo descargado correctamente: /InputFiles/freshwatersubset_cesar_capinha_et_al_2017.xlsx")
}
