Bambaradeniya_et_Al_2002_Download_and_Depurate <- function(){
  ...
  destfile <- "InputFiles/Step0_OriginalDatabase_Bambaradeniya_et_Al_2002.pdf"
  ...
  write.xlsx(dataset, "Inputfiles/Step0_OriginalDatabase_Bambaradeniya_et_Al_2002.xlsx")
  ...
  write.xlsx(freshwater_species, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Bambaradeniya_et_Al_2002.xlsx")
}
