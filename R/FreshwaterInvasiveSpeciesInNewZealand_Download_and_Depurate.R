FreshwaterInvasiveSpeciesInNewZealand_Download_and_Depurate <- function(){
  ...
  write.xlsx(dataset_freshwater, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_FreshwaterInvasiveSpeciesinNewZealand.xlsx")
  cat("Archivo guardado correctamente: Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_FreshwaterInvasiveSpeciesinNewZealand.xlsx")
}
