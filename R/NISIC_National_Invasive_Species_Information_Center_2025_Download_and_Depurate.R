NISIC_National_Invasive_Species_Information_Center_2025_Download_and_Depurate <- function(){
  ...
  write.xlsx(NISIC_National_Invasive_Species_Information_Center_2025_allspecies, "./Inputfiles/Step0_OriginalDatabase_NISIC_National_Invasive_Species_Information_Center_2025.xlsx")
  cat("Archivo descargado correctamente: Step0_OriginalDatabase_NISIC_National_Invasive_Species_Information_Center_2025.xlsx", "\n")
  write.csv2(NISIC_National_Invasive_Species_Information_Center_2025_allspecies, "./Inputfiles/Step0_OriginalDatabase_NISIC_National_Invasive_Species_Information_Center_2025.csv")
  cat("Archivo descargado correctamente: Step0_OriginalDatabase_NISIC_National_Invasive_Species_Information_Center_2025.csv", "\n")
  ...
  write.xlsx(dataset, "./Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_NISIC_National_Invasive_Species_Information_Center_2025.xlsx")
  cat("Archivo descargado correctamente: Step0_OriginalDatabaseFreshwaterNODUPLICATES_NISIC_National_Invasive_Species_Information_Center_2025.xlsx", "\n")
