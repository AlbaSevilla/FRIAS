InvasiveSpeciesKorea_Download_and_Depurate <- function(){
  ###########################################################
  ################## DESCARGAR ##############################
  ###########################################################
  url <- "https://koreascience.kr/article/JAKO201726439088155.pdf"
  destfile <- "InputFiles/Step0_OriginalDatabase_InvasiveSpeciesKorea.pdf"
  ...
  write_xlsx(Tabla_final, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_InvasiveSpeciesKorea.xlsx")
}
