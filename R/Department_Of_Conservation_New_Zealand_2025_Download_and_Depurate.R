Department_Of_Conservation_New_Zealand_2025_Download_and_Depurate <- function(){
  ...
  #GUARDAMOS
  write.xlsx(resultados, "Inputfiles/Step0_OriginalDatabase_Department_Of_Conservation_New_Zealand_2025.xlsx")
  write.xlsx(resultados, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Department_Of_Conservation_New_Zealand_2025.xlsx")
}
