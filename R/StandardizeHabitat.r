StandardizeHabitat <- function() {
  ...
  # Save
  write_xlsx(MasterlistStandardized2, "OutputFiles/Intermediate/step11_standardizedhabitat_masterlist.xlsx")
  write_csv(MasterlistStandardized2, "OutputFiles/Intermediate/step11_standardizedhabitat_masterlist.csv")
}
