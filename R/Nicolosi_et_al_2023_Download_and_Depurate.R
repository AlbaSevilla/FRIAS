Nicolosi_et_al_2023_Download_and_Depurate <- function(){
  ...
  #Depurar
  dat <- read_excel("InputFiles/Step0_OriginalDatabase_Nicolosi_et_al_2023.xlsx", col_names = TRUE)
  names(dat)
  ...
  write.xlsx(dat_fresh, "InputFiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Nicolosi_et_al_2023.xlsx")
