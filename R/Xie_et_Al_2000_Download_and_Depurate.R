Xie_et_Al_2000_Download_and_Depurate <- function(){
  ...
  ###########################################################
    ...
    destfile <- "InputFiles/Step0_OriginalDatabase_Xie_et_Al_2000.pdf"
    ...
    write.xlsx(DATASET_CHINA, "./Inputfiles/Step0_OriginalDatabase_Xie_et_Al_2000.xlsx")

    #####################################################################################
    ################## FUNCTION TO OBTAIN SPECIES HABITAT ###############################
    #####################################################################################
    DATASET_CHINA <- read_excel("Inputfiles/Step0_OriginalDatabase_Xie_et_Al_2000.xlsx")
    ...
    write.xlsx(dataset_freshwater, "./Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Xie_et_Al_2000.xlsx")
    cat("Archivo descargado correctamente: /Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Xie_et_Al_2000.xlsx")
