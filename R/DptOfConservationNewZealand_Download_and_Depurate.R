DptOfConservationNewZealand_Download_and_Depurate <- function(){
  ...
  tags_a
  # Convertir cada nodo <a> a su HTML como texto
  tags_a_html <- as.character(tags_a)
  # Filtrar los que contienen <em>
  ...
  #GUARDAMOS
  write.xlsx(resultados, "Inputfiles/Step0_OriginalDatabase_DptOfConservationNewZealand.xlsx")
  write.xlsx(resultados, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_DptOfConservationNewZealand.xlsx")
}
