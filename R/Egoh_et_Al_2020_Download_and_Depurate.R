Egoh_et_Al_2020_Download_and_Depurate <- function(){
  ...
  destfile <- "InputFiles/Step0_OriginalDatabase_Egoh_et_Al_2020.docx"
  ...
  dat <- read_docx("Inputfiles/Step0_OriginalDatabase_Egoh_et_Al_2020.docx")
  ...
  write.xlsx(dat_fresh2, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Egoh_et_Al_2020.xlsx")
  cat("Archivo descargado correctamente: Step0_OriginalDatabaseFreshwaterNODUPLICATES_Egoh_et_Al_2020.xlsx", "\n")
  # write.csv2(Egoh_et_Al_2020_sinduplicados, "./Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Egoh_et_Al_2020.csv")
  # cat("Archivo descargado correctamente: Step0_OriginalDatabaseFreshwaterNODUPLICATES_Egoh_et_Al_2020.csv", "\n")
  #
}
