FishBase_2025_Download_and_Depurate <- function() {
  ...
  write.xlsx(dataframe_species_dataset, file.path("InputFiles", "Step0_OriginalDatabase_FishBase_2025.xlsx"))
  ...
  write.xlsx(FishBase_sinduplicados, file.path("InputFiles", "Step0_OriginalDatabaseFreshwater_FishBase_2025.xlsx"))

  FishBase_sinduplicados <- read_excel("Inputfiles/Step0_OriginalDatabaseFreshwater_FishBase_2025.xlsx")
  ...
  write.xlsx(FishBase_sinduplicados4, file.path("InputFiles", "Step0_OriginalDatabaseFreshwaterNODUPLICATES_FishBase_2025.xlsx"))
  cat("Archivo descargado correctamente: InputFiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_FishBase_2025.xlsx")
}
