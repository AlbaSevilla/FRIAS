Larissa_et_al_2017_Download_and_Depurate <- function(){
  ...
  destfile <- "InputFiles/Step0_OriginalDatabase_Larissa_et_al_2017.xlsx"
  download.file(url, destfile, mode = "wb")

  ##########################################################
  ############### obtener información de interés ###########
  ##########################################################
  dat <- read_excel("Inputfiles/Step0_OriginalDatabase_Larissa_et_al_2017.xlsx", sheet="Introduced Species")
  head(dat)
  ...
  write.xlsx(freshwater_species, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Larissa_et_al_2017.xlsx")
}
