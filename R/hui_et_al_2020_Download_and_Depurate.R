hui_et_al_2020_Download_and_Depurate <- function(){
  ...
  ##########################################################
  archivo <- "Inputfiles/originaldatabase_hui_et_al_2020.pdf"
  ...
  # 11. Exporta a Excel
  write.xlsx(tabla_df2, "Inputfiles/originaldatabase_hui_et_al_2020.xlsx", rowNames = FALSE)
  ...
  write.xlsx(tabla_df3, "Inputfiles/freshwatersubset_hui_et_al_2020.xlsx")
}
