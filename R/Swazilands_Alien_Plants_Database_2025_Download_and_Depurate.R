Swazilands_Alien_Plants_Database_2025_Download_and_Depurate <- function(){
  #DESCARGAR
  # Leer la página web
  ...
  #Guardamos
  write.xlsx(resultados, "Inputfiles/Step0_OriginalDatabase_Swazilands_Alien_Plants_Database_2025.xlsx")
  ...
  #Guardamos
  write.xlsx(dataset, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Swazilands_Alien_Plants_Database_2025.xlsx")
