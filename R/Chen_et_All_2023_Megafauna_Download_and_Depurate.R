Chen_et_al_2023_Megafauna_Download_and_Depurate <- function(){
  ...
  ##########################################################
  dataset <- read_excel("InputFiles/Step0_OriginalDatabase_Chen_et_al_2023.xlsx",
                                                              col_names = TRUE)
  ...
  write.xlsx(dataset_sinduplicados, "InputFiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Chen_et_al_2023.xlsx")
}
