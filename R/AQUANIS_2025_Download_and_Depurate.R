AQUANIS_2025_Download_and_Depurate <- function(){
  ...
  write.xlsx (dataset_habitat, "./InputFiles/Step0_OriginalDatabase_AQUANIS_2025.xlsx")


  ###################################################################################
  ######################### freshwater ##############################################
  ###################################################################################
  dataset_HAB <- read_excel("InputFiles/Step0_OriginalDatabase_AQUANIS_2025.xlsx")
  ...
  # url <- "https://AQUANIS_2025research.com/AQUANIS_2025/species/view/id/1986" #Link que nos sale en tabla_filtrada$Link
  # res <- read_html(url)
  # res2 <- res %>% html_table
  ...
  write.xlsx (dataset_final, "./InputFiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_AQUANIS_2025.xlsx")
}
