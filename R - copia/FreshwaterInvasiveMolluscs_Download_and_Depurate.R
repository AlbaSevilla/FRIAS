FreshwaterInvasiveMolluscs_Download_and_Depurate <- function(){
  #DESCARGAR
  ...
  write.xlsx(res3, "Inputfiles/Step0_OriginalDatabase_FreshwaterInvasiveMolluscs.xlsx")
  write.xlsx(res3, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_FreshwaterInvasiveMolluscs.xlsx")
  ##################################
  ######### HABITAT ################
