Mikkola_et_al_2012_Download_and_Depurate <- function(){
  ...
  write.xlsx(res4, "InputFiles/Step0_OriginalDatabase_Mikkola_et_al_2012.xlsx")
  ...
  write.xlsx(dat_fresh2, "InputFiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Mikkola_et_al_2012.xlsx")
