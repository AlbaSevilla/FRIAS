GlobalCompendiumofWeedsGCW_Download_and_Depurate <- function(){
  ...
  write.xlsx(dat_act, "Inputfiles/Step0_originalDatabase_GlobalCompendiumofWeedsGCW.xlsx")
  ...
  especies2 <- read_excel("Inputfiles/Step0_originalDatabaseFreshwaterNODUPLICATES_GlobalCompendiumofWeedsGCW.xlsx")
  ...
  write.xlsx(AlienSpecies, "Inputfiles/Step0_OriginalDatabaseAlienFreshwaterNODUPLICATES_GlobalCompendiumofWeedsGCW.xlsx")
}
