catalogo_espanol_de_especies_exoticas_invasoras_2023_Download_and_Depurate <- function() {
  ...
  mi_excel <- read_excel("Inputfiles/originaldatabase_catalogo_espanol_de_especies_exoticas_invasoras_2023.xlsx")  # Cambia esta ruta por la ubicación de tu archivo
  # Guardar como archivo CSV
  write.csv2(mi_excel, "Inputfiles/originaldatabase_catalogo_espanol_de_especies_exoticas_invasoras_2023.csv", row.names = FALSE)
  ...
  dat <- read.csv("Inputfiles/originaldatabase_catalogo_espanol_de_especies_exoticas_invasoras_2023.csv",sep=";")#Aquí estamos indicando que sustraiga los excel de las bases de dat iniciales de la carpeta 'InputFiles'.
  head(dat)
  names(dat)
  ...
  #NO DUPLICADOS
  catalogo_espanol_de_especies_exoticas_invasoras_2023_subset_sinduplicados <- catalogo_espanol_de_especies_exoticas_invasoras_2023_rangoespecie %>%
  ...
  #Obtain habitats
  dataset <- catalogo_espanol_de_especies_exoticas_invasoras_2023_subset_sinduplicados
