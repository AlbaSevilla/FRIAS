garcia_berthou_et_al_2004_Download_and_Depurate <- function(){
  ...
  write_xlsx(dataset_garcía_berthou_et_al_20042,"Inputfiles/originaldatabase_garcia_berthou_et_al_2004.xlsx")
  cat("Archivo guardado correctamente : Inputfiles/originaldatabase_garcia_berthou_et_al_2004.xlsx")
  ...
  write_xlsx(dataset_freshwater2, "Inputfiles/freshwatersubset_garcia_berthou_et_al_2004.xlsx")
}
