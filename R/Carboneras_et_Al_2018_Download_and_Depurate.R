Carboneras_et_Al_2018_Download_and_Depurate <- function(){
  ...
  ########## DEPURAR ##############
  #################################
  dataset_Carboneras <- read.xlsx(file.path("Inputfiles","Carboneras_et_Al_2018ST2.xlsx"),sheet = "EU IAS prioritised list")
  ...
  write.xlsx(dataset_freshwater, "./Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Carboneras_et_Al_2018.xlsx")
  cat("Archivo descargado correctamente: /Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Carboneras_et_Al_2018.xlsx")
}
