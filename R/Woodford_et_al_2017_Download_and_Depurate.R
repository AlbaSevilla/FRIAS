Woodford_et_al_2017_Download_and_Depurate <- function(){
  ...
  destfile <- "InputFiles/Step0_OriginalDatabase_Woodford_et_al_2017.pdf"
  ...
  names(dataset)
  write.xlsx(dataset, "Inputfiles/Step0_OriginalDatabase_Woodford_et_al_2017.xlsx")

  #Habitat
  dataset <- read_excel("Inputfiles/Step0_OriginalDatabase_Woodford_et_al_2017.xlsx")
  ...
  write.xlsx(freshwater_species2, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Woodford_et_al_2017.xlsx")
}
