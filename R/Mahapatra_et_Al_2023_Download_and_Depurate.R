Mahapatra_et_Al_2023_Download_and_Depurate <- function(){
  ...
  write.xlsx(res3, "Inputfiles/Step0_OriginalDatabase_Mahapatra_et_Al_2023.xlsx")
  write.xlsx(res3, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Mahapatra_et_Al_2023.xlsx")
  ##################################
  ######### HABITAT ################
