Obtain_FunctionalGroup <- function() {
  ...
  MasterList <- read.csv("OutputFiles/Intermediate/step13_standardizedpathway_masterlist.csv")
  ...
  #SAVE FINAL
  write.xlsx(final, "OutputFiles/Intermediate/step14_obtainfunctionalgroup_masterlist.xlsx")
  write.csv(final, "OutputFiles/Intermediate/step14_obtainfunctionalgroup_masterlist.csv",
            row.names = FALSE)
}
