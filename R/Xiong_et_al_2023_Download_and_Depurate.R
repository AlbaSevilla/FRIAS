Xiong_et_al_2023_Download_and_Depurate <- function(){
  ...
  destfile <- "InputFiles/Step0_OriginalDatabase_Xiong_et_al_2023.docx"
  ...
  ##########################################################
  # Leer el documento
  doc <- read_docx("Inputfiles/Step0_OriginalDatabase_Xiong_et_al_2023.docx")
  ...
  write.xlsx(freshwater_species, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Xiong_et_al_2023.xlsx")
  cat("Descargado Step0_OriginalDatabaseFreshwaterNODUPLICATES_Xiong_et_al_2023.xlsx")
}
