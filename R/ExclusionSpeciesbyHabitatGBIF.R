ExclusionSpeciesbyHabitatGBIF <- function(){
  ...
  freshwater_database <- freshwater_habitats %>%
    ...
    select(
      ...
      Group,pathway,ReportYear,EarliestReport,NativeRange,RecipientRange,
      RecipientRangeISO3,AffectedTaxa,Impact,Mechanisms,Impact_by_Mechanism,Habitat,Source_Data)
