Saffer_et_Al_2024_Download_and_Depurate <- function(){
  ######################################################
  ######### PARA DESCARGAR #############################
  ######################################################
  url <- "https://zenodo.org/records/15498757/files/GIATAR.zip?download=1"
  destfile <- "InputFiles/Step0_OriginalDatabase_Saffer_et_Al_2024.zip"
  ...
  #TARDA UN RATILLO
  unzip("InputFiles/Step0_OriginalDatabase_Saffer_et_Al_2024.zip", exdir = "InputFiles")
  ...
  write_xlsx(Dataset_Completo2, "Step0_OriginalDatabase_Saffer_et_Al_2024.xlsx")
  ...
  write.xlsx(dat_fresh, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Saffer_et_Al_2024.xlsx")
}
