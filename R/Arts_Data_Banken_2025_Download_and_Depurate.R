Arts_Data_Banken_2025_Download_and_Depurate <- function(){
  #DOWNLOAD
  #in web https://lister.artsdatabanken.no/fremmedartslista/2023?TaxonRank=AssessedAtSameRank

  #DEPURATE:
  dat <- read_excel("InputFiles/Step0_OriginalDatabase_Arts_Data_Banken_2025.xlsx")
  names(dat)
#
...
#   names(dat2)[names(dat2) == "Vitenskapelig navn"] <- "Nombre_Cientifico"
  ...
  write.xlsx(dat_noduplicates, "InputFiles/Step0_OriginalDatabase_Arts_Data_Banken_2025.xlsx")
  #######################################################
  ############ habitat ##################################
  #######################################################
  ...
  write.xlsx(dat_fresh, "InputFiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Arts_Data_Banken_2025.xlsx")
  cat("Archivo descargado: Step0_OriginalDatabaseFreshwaterNODUPLICATES_Arts_Data_Banken_2025.xlsx")
