Nunes_et_Al_2025_Download_and_Depurate <- function() {
  ...
  write.xlsx(dataset_freshwater1, "./Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES1_Nunes_et_Al_2025.xlsx")
  cat("Archivo descargado correctamente: Step0_OriginalDatabaseFreshwaterNODUPLICATES1_Nunes_et_Al_2025.xlsx", "\n")
  # write.csv2(dataset_freshwater, "./Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Nunes_et_Al_2025.csv")
  # cat("Archivo descargado correctamente: Step0_OriginalDatabaseFreshwaterNODUPLICATES_Nunes_et_Al_2025.csv", "\n")
  ...
  write.xlsx(dataset_freshwater2, "./Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES2_Nunes_et_Al_2025.xlsx")
  cat("Archivo descargado correctamente: Step0_OriginalDatabaseFreshwaterNODUPLICATES2_Nunes_et_Al_2025.xlsx", "\n")
  ...
  write.xlsx(dataset_freshwater3, "./Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES3_Nunes_et_Al_2025.xlsx")
  cat("Archivo descargado correctamente: Step0_OriginalDatabaseFreshwaterNODUPLICATES3_Nunes_et_Al_2025.xlsx", "\n")


  #AHORA JUNTAMOS TODOS LOS DATASETS:
  dataset_freshwater1 <- read_excel("Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES1_Nunes_et_Al_2025.xlsx")
  dataset_freshwater2 <- read_excel("Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES2_Nunes_et_Al_2025.xlsx")
  dataset_freshwater3 <- read_excel("Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES3_Nunes_et_Al_2025.xlsx")
  ...
  write.xlsx(dataset, "./Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Nunes_et_Al_2025.xlsx")
  cat("Archivo descargado correctamente: Step0_OriginalDatabaseFreshwaterNODUPLICATES_Nunes_et_Al_2025.xlsx", "\n")
}
