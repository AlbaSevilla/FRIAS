Flora_Croatica_Database_2025_Download_and_Depurate <- function(){
  ...
  destfile <- "InputFiles/Step0_OriginalDatabase_Flora_Croatica_Database_2025.zip"
  ...
  unzip("InputFiles/Step0_OriginalDatabase_Flora_Croatica_Database_2025.zip", exdir = "InputFiles")
  ...
  write.xlsx(dat, "Inputfiles/Step0_OriginalDatabase_Flora_Croatica_Database_2025.xlsx")
  ...
  write.xlsx(dat_fresh, "Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_Flora_Croatica_Database_2025.xlsx")
}
