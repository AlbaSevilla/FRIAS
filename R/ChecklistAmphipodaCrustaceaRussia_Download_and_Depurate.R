ChecklistAmphipodaCrustaceaRussia_Download_and_Depurate <- function(){
  ###########################################################
  ################## DESCARGAR ##############################
  ###########################################################
  url <- "http://kmkjournals.com/upload/PDF/ArthropodaSelecta/24/24_3_335_370_Takhteev_et_al_for_Inet.pdf"
  destfile <- "InputFiles/Step0_OriginalDatabase_ChecklistAmphipodaCrustaceaRussia.pdf"
  ...
  Dataset <- read_excel("Inputfiles/Step0_OriginalDatabase_ChecklistAmphipodaCrustaceaRussia.xlsx")
  ...
  write.xlsx(dataset_freshwater, "./Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_ChecklistAmphipodaCrustaceaRussia.xlsx")
  cat("Archivo descargado correctamente: /Inputfiles/Step0_OriginalDatabaseFreshwaterNODUPLICATES_ChecklistAmphipodaCrustaceaRussia.xlsx")
